...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://use.typekit.net/egt1epc.css">
    <link rel="stylesheet" href="dist/styles<?php echo $env == 'production' ? '.min' : ''; ?>.css">
  ...
  <body>
    ...
    <header class="header">
      ...
      <div class="header__side">
        <div class="header__side-img-wrapper">
          <img class="header__side-img" src="dist/header-side-img.jpeg" alt="Portrait of a Medgar Evers." />
        </div>
        <div class="header__side-img-wrapper">
          <img class="header__side-img" src="dist/Fannie_Lou_Hamer_1964-08-22.jpg" alt="Fannie Lou Hamer, 1964." />
        </div>
        <div class="header__side-img-wrapper">
    ...
    <section class="section plan">
      ...
      <a class="button--wider section__button" href="https://msvotes.org/voter-services/political-education/" target="_blank" rel="noopener nofollow">Click here to pledge your vote</a>
    ...
    <section class="section--reverse bank">
      ...
      <a class="button section__button" href="http://onevoicems.org/election-protection-2019-general-volunteer-application/" target="_blank" rel="nooper nofollow">Click here to volunteer</a>
      <div class="section__icon-wrapper">
    ...
    <section class="section polling">
      ...
      <a class="button section__button" href="https://www.msegov.com/sos/voter_registration/AmIRegistered" target="_blank" rel="noopener nofollow">Click here to check your info</a>
      <div class="section__icon-wrapper">
        <img class="section__icon map" src="dist/map.svg" alt="Map" />
      </div>
    </section>
